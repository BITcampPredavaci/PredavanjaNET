...
namespace S08D04_MiniApp.Controllers
{
    ...
    public class MicroPostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MicroPostId,Title,Content,CategoryId")] MicroPost microPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MicroPostId,Title,Content,CategoryId")] MicroPost microPost)
        {
            if (ModelState.IsValid)
            {
